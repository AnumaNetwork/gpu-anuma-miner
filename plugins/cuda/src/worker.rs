...
use cust::prelude::*;
use anuma_miner::xoshiro256starstar::Xoshiro256StarStar;
use anuma_miner::Worker;
use log::{error, info};
...
static PTX_86: &str = include_str!("../resources/anuma-cuda-sm86.ptx");
static PTX_75: &str = include_str!("../resources/anuma-cuda-sm75.ptx");
static PTX_61: &str = include_str!("../resources/anuma-cuda-sm61.ptx");
static PTX_30: &str = include_str!("../resources/anuma-cuda-sm30.ptx");
static PTX_20: &str = include_str!("../resources/anuma-cuda-sm20.ptx");
